...
\[{T_{dc}}\left( {{\mathbf{k}},{a^2}G{\rho _0}} \right) = \frac{{4\pi  \cdot k_x^2k_y^2}}{{{k^4} + {{\tilde a}^2} \cdot {k^6}}}\quad {{\tilde a}^2} = 8\pi {a^2}G{\rho _0}\]
...
\subsubsection{Regularizáció erősségének hatása a kiválasztott hullámhosszon}
...
egyenletet kell megoldani. Ezt ábrázolhatjuk $-B = A = D = 1$ értékek mellett.


\paragraph{Ha $\tilde a \approx 1$}, akkor érdekes a jelenség igazán.
