...
addresource=video/2.flv,
activate=pageopen,
passcontext,
flashvars={source=video/2.flv&loop=true}]{\includegraphics[width=0.5\textwidth]{video/2.png}}{VPlayer.swf}
\caption{Videó}
\end{figure}
...
\end{subfigure}
\caption{Különböző erősségű core regularizációval $\lambda_+$, oldott atomok nélkül}
\end{figure}
\end{document}
